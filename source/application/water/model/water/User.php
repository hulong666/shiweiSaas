...
namespace app\water\model\water;

use think\Session;
use app\common\model\water\User as WaterUserModel;
 ...
 */
class User extends WaterUserModel
{
    /**
     * 商家用户登录
     * @param $data
...
//        }
    ...
    public function add($data)
    {
        ...
        try {
            ...
            // 新增角色关系记录
            (new UserRole)->add($this['water_user_id'], $data['role_id']);
            $this->commit();
            return true;
        } catch (\Exception $e) {
    ...
    public function edit($data)
    {
        ...
        try {
            ...
            $this->allowField(true)->save($data);
            // 更新角色关系记录
            (new UserRole)->edit($this['water_user_id'], $data['role_id']);
            $this->commit();
            return true;
        } catch (\Exception $e) {
            $this->error = $e->getMessage();
    ...
    public function setDelete()
    {
        ...
        // 删除对应的角色关系
        UserRole::deleteAll(['water_user_id' => $this['water_user_id']]);
    ...
    public function renew($data)
    {
        ...
        Session::set('yoshop_store.user', [
            'water_user_id' => $this['water_user_id'],
            'user_name' => $data['user_name'],
        ]);
        return true;
    }
