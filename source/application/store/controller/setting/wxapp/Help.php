...
namespace app\store\controller\setting\wxapp;
...
class Help extends Controller
{
    ...
    public function add()
    {
        ...
        if ($model->add($this->postData('help'))) {
            return $this->renderSuccess('添加成功', url('setting.wxapp.help/index'));
        }
    ...
    public function edit($help_id)
    {
        ...
        if ($model->edit($this->postData('help'))) {
            return $this->renderSuccess('更新成功', url('setting.wxapp.help/index'));
        }
