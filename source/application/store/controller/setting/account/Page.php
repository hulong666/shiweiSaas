...
namespace app\store\controller\setting\account;
...
use app\store\model\AccountPage as AccountPageModel;
use app\store\model\AccountCategory as AccountCategoryModel;
...
class Page extends Controller
{
    ...
    public function add()
    {
        ...
        return $this->renderSuccess('添加成功', url('setting.account.page/index'));
    }
    ...
    {
        $model = AccountPageModel::detail($page_id);
        if (!$this->request->isAjax()) {
            return $this->fetch('edit', [
                'defaultData' => json_encode($model->getDefaultItems()),
    ...
    {
        $model = AccountCategoryModel::detail();
        if ($this->request->isAjax()) {
