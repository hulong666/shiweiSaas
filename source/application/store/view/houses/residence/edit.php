                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="area"
                                           value="<?= $model['area'] ?>" placeholder="请输入面积" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="price"
                                           value="<?= $model['price'] ?>" placeholder="请输入单价" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">租金 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="rent"
                                           value="<?= $model['rent'] ?>" placeholder="请输入租金" required>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="lease_type" value="1" data-am-ucheck
                                            <?= $model['lease_type'] == 1 ? 'checked' : '' ?>>
                                        整租
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="lease_type" value="2" data-am-ucheck
                                            <?= $model['lease_type'] == 2 ? 'checked' : '' ?>>
                                        合租
                                    </label>
                                </div>
                            </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-end">
                                            <select name="room" id="room"
                                                    data-am-selected="{btnSize: 'sm', placeholder: '请选择楼盘',searchBox: 1,maxHeight: 100}">
                                                <?php for ($i = 0; $i <= 10; $i++): ?>
                                                    <option value="<?= $i ?>" <?= $model['room'] == $i ? 'selected' : '' ?>>
                                                        <?= $i.'室' ?>
                                                    </option>
                                                <?php endfor; ?>
                                            </select>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-end">
                                            <select name="hall" id="hall"
                                                    data-am-selected="{btnSize: 'sm', placeholder: '请选择楼盘',searchBox: 1,maxHeight: 100}">
                                                <?php for ($i = 0; $i <= 10; $i++): ?>
                                                    <option value="<?= $i ?>" <?= $model['hall'] == $i ? 'selected' : '' ?>>
                                                        <?= $i.'厅' ?>
                                                    </option>
                                                <?php endfor; ?>
                                            </select>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-end">
                                            <select name="toilet" id="toilet"
                                                    data-am-selected="{btnSize: 'sm', placeholder: '请选择楼盘',searchBox: 1,maxHeight: 100}">
                                                <?php for ($i = 0; $i <= 10; $i++): ?>
                                                    <option value="<?= $i ?>" <?= $model['toilet'] == $i ? 'selected' : '' ?>>
                                                        <?= $i.'卫' ?>
                                                    </option>
                                                <?php endfor; ?>
                                            </select>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="wuye"
                                           value="<?= $model['wuye'] ?>" placeholder="请输入物业费" required>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="renovation" id="renovation"
                                        ...
                                        <option value=""></option>
                                        <option value="简装" <?= $model['renovation'] == '简装' ? 'selected' : '' ?>>
                                            简装
                                        </option>
                                        <option value="精装" <?= $model['renovation'] == '精装' ? 'selected' : '' ?>>
                                            精装
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="contacts"
                                           value="<?= $model['contacts'] ?>" placeholder="请输入联系人" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <?php foreach ($configure as $k => $v): ?>
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" value="<?= $k+1 ?>" <?= in_array($k+1,$model['configure']) ? 'checked' : '' ?>> <?= $v ?>
                                    </label>
                                <?php endforeach; ?>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <?php foreach ($label as $item): ?>
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" value="<?= $item['id'] ?>" <?= in_array($item['id'],$model['label']) ? 'checked' : '' ?>> <?= $item['labelname'] ?>
                                    </label>
                                <?php endforeach; ?>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <video width="320" height="240" controls>
                                        ...
                                        <object data="<?= $model['video'] ?>" width="320" height="240">
                                            <embed src="<?= $model['video'] ?>" width="320" height="240">
                                        </object>
                                    </video>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <!-- 加载编辑器的容器 -->
                                    <textarea id="container" name="message"
                                              type="text/plain"><?= $model['message'] ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="policy"
                                           value="<?= $model['policy'] ?>" placeholder="请输入佣金政策">
                                </div>
                            </div>
