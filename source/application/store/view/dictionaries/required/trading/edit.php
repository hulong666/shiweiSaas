                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="province_id" id="province_id"
                                            data-am-selected="{btnSize: 'sm', placeholder: '请选择省份',searchBox: 1,maxHeight: 100}">
                                        <option value=""></option>
                                        <?php foreach ($province as $item): ?>
                                            <option value="<?= $item['id'] ?>"
                                                <?= $model['province_id'] == $item['id'] ? 'selected' : '' ?>>
                                                <?= $item['name'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="city_id" id="city_id"
                                        ...
                                        <?php foreach ($city as $item): ?>
                                            <option value="<?= $item['id'] ?>"
                                                <?= $model['city_id'] == $item['id'] ? 'selected' : '' ?>>
                                                <?= $item['name'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="region_id" id="region_id"
                                        ...
                                        <?php foreach ($regin as $item): ?>
                                            <option value="<?= $item['id'] ?>"
                                                <?= $model['region_id'] == $item['id'] ? 'selected' : '' ?>>
                                                <?= $item['name'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="name"
                                           value="<?= $model['name'] ?>" placeholder="请输入地铁名称" required>
                                </div>
                            </div>
