                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">租客在线缴费设置</div>
                            </div>
                            ...
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">租客在线服务设置</div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">租客智能管理设置</div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">租客端水电单价的显示</div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">租客在线报修上传视频</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require">
                                    租客在线报修上传视频
                            ...
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">租客管家显示设置</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require">
                                    租客管家显示设置
