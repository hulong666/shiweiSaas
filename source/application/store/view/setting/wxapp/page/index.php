                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                        <div class="am-form-group">
                            <div class="am-btn-toolbar">
                                <?php if (checkPrivilege('setting.wxapp.page/add')): ?>
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-success am-radius"
                                           href="<?= url('setting.wxapp.page/add') ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('setting.wxapp.page/edit')): ?>
                                                <a href="<?= url('setting.wxapp.page/edit', ['page_id' => $item['page_id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; ?>
                                            <?php if ($item['page_type'] == 20) : ?>
                                                <?php if (checkPrivilege('setting.wxapp.page/delete')): ?>
                                                    <a href="javascript:;"
                                                ...
                                                <?php endif; ?>
                                                <?php if (checkPrivilege('setting.wxapp.page/sethome')): ?>
                                                    <a href="javascript:;"
...
<script>
    $(function () {
        ...
        // 删除元素
        $('.item-delete').delete('page_id', "<?= url('setting.wxapp.page/delete') ?>");

        // 设为首页
        $('.j-setHome').click(function () {
            var pageId = $(this).attr('data-id');
            layer.confirm('确定要将此页面设置为默认首页吗？', function (index) {
                $.post("<?= url('setting.wxapp.page/sethome') ?>", {page_id: pageId}, function (result) {
