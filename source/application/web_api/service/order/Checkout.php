...
namespace app\web_api\service\order;

use app\api\model\Order as OrderModel;

use app\web_api\model\User as UserModel;
use app\web_api\model\Goods as GoodsModel;
use app\web_api\model\Setting as SettingModel;
use app\web_api\model\store\Shop as ShopModel;
use app\web_api\model\UserCoupon as UserCouponModel;
use app\web_api\model\dealer\Order as DealerOrderModel;

use app\web_api\service\User as UserService;
use app\web_api\service\Payment as PaymentService;
use app\web_api\service\coupon\GoodsDeduct as GoodsDeductService;
use app\web_api\service\points\GoodsDeduct as PointsDeductService;
use app\web_api\service\order\source\checkout\Factory as CheckoutFactory;
 ...
 * 订单结算台服务类
 * Class Checkout
 * @package app\web_api\service\order
 */
class Checkout
{
