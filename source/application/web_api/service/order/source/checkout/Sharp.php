...
namespace app\web_api\service\order\source\checkout;

use app\web_api\service\sharp\Order as SharpOrderService;

/**
 * 订单结算台-秒杀商品扩展类
 * Class Sharp
 * @package app\web_api\service\order\source\checkout
 */
